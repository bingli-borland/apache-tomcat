...
public class TestELInJsp extends TomcatBaseTest {
    ...
    /*
     * BZ https://bz.apache.org/bugzilla/show_bug.cgi?id=57142 jakarta.servlet, javax.servlet.http and jakarta.servlet.jsp
    ...
    public void testBug69635() throws Exception {
        ...
        ByteChunk res = getUrl("http://localhost:" + getPort() + "/test/bug6nnnn/bug69635.jsp");
        String result = res.toString();
