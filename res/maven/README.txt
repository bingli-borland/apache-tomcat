...
2 - mvn install:install-file -Dfile=E:\project\tomcat9\output\release\v9.0.110-jakarta\bin\apache-tomcat-9.0.110-jakarta.zip -DgroupId=org.apache.tomcat -DartifactId=tomcat -Dversion=9.0.110-jakarta  -Dpackaging=zip
