...
import org.apache.tomcat.websocket.jetty.util.StringUtil;
import org.apache.tomcat.websocket.jetty.util.Uptime;
...
{
    private static final InternalLogger LOG = InternalLoggerFactory.getInstance(AbstractLifeCycle.class);
