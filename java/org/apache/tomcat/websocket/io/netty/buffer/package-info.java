 ...
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf}, has been designed from ground
 ...
 * <h3>Extensibility</h3>
 *
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} has rich set of operations
 * optimized for rapid protocol implementation.  For example,
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} provides various operations
 ...
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} interface rather than
 ...
 * </pre>
 * By contrast, {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} does not have such
 ...
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} message = {@link org.apache.tomcat.websocket.io.netty.buffer.Unpooled}.wrappedBuffer(header, body);
 *
 * // Therefore, you can even create a composite by mixing a composite and an
 * // ordinary buffer.
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} messageWithFooter = {@link org.apache.tomcat.websocket.io.netty.buffer.Unpooled}.wrappedBuffer(message, footer);
 *
 * // Because the composite is still a {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf}, you can access its content
 ...
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} b = {@link org.apache.tomcat.websocket.io.netty.buffer.Unpooled}.buffer(4);
 *
 ...
 * {@link org.apache.tomcat.websocket.io.netty.buffer.ByteBuf} is a very thin wrapper of a
